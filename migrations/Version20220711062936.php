 ...
 */
final class Version20220711062936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE section_niveau DROP FOREIGN KEY FK_197014DECA194AC');
        $this->addSql('DROP INDEX IDX_197014DECA194AC ON section_niveau');
        $this->addSql('ALTER TABLE section_niveau DROP tarif_pack_niveau_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE section_niveau ADD tarif_pack_niveau_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE section_niveau ADD CONSTRAINT FK_197014DECA194AC FOREIGN KEY (tarif_pack_niveau_id) REFERENCES tarif_pack_niveau (id)');
        $this->addSql('CREATE INDEX IDX_197014DECA194AC ON section_niveau (tarif_pack_niveau_id)');
    }
}
